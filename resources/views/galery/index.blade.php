      ...
      <div class="container">
          <div class="portfolio_filter">
              <ul>
                  ...
                  <li data-filter=".brand" class=""><a href="#">Brand identity</a></li>
                  <li data-filter=".design" class=""><a href="#">Design</a></li>
                  <li data-filter=".arc" class=""><a href="#">Architecture</a></li>
                  <li data-filter=".photo" class="active"><a href="#">Photography</a></li>
              </ul>
          </div>
      </div>
